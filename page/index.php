...
<body>
    ...
    <form method="post" action="../include/insert-post.php">
        ...
        <div><input type="submit" id="submit" name="public_post" href="code.php" value="Create Public post">
            <input type="submit" id="submit" name="private_post" value="Create Private post">
        </div>
    </form>
    <tbody>
        <?php
